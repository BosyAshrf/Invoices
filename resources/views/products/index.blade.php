                            ...
                            <tbody>
                                ...
                                @foreach ($products as $product)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $product->description == true ? $product->description : 'لاتوجد ملاحظات' }}
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                <button aria-expanded="false" aria-haspopup="true"
                                                    ...
                                                    data-target="#Edit{{ $product->id }}"><i
                                                    class="text-info fas fa-edit"></i>
                                                    &nbsp;&nbsp;Edit Product</a>
                                                    @endcan

                                                    <a class="dropdown-item" data-toggle="modal"
                                                    data-target="#note{{ $product->id }}"><i
