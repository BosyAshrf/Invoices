								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">اجمالى الفواتير : {{ \App\invoices::count() }}</p>
										</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">اجمالى الفواتير : {{ \App\invoices::where('Value_Status',2)->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">اجمالى الفواتير : {{ \App\invoices::where('Value_Status',1)->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">اجمالى الفواتير : {{ \App\invoices::where('Value_Status',3)->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
						...
						<div class="card">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
								<div class="d-flex justify-content-between">
									<h3 class="card-title mb-0">نسبة احصائية الفواتير </h3>
					...
					<div class="col-lg-12 col-xl-5">
						<div class="card card-dashboard-map-one">
							<label class="main-content-label">نسبة احصائية الفواتير </label>
								<div class="vmap-wrapper ht-180" style="width":100%>
									{!! $chartjs_2->render() !!}
							</div>
						</div>
					</div>
